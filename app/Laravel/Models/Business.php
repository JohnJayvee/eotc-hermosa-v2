...
class Business extends Model{
    ...
    public function getLessorAddressAttribute(){
        return Str::title((strlen($this->lessor_unit_no) > 0 ? " ".$this->lessor_unit_no : NULL)." {$this->lessor_street_address} {$this->lessor_brgy_name}");
    }
