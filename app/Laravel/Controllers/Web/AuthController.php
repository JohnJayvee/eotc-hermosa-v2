...
class AuthController extends Controller{
	...
	public function store(RegisterRequest $request){
            ...
            $new_customer->fname = $request->get('fname');
            $new_customer->lname = $request->get('lname');
            $new_customer->mname = $request->get('mname');
            $new_customer->email = $request->get('email');
            $new_customer->gender = $request->get('gender');
            $new_customer->contact_number = $request->get('contact_number');
